                ...
                <div class="bg-white rounded-lg sm:rounded-md border  border-gray-400 w-full sm:w-52">
                    ...
                    <div class="px-4 py-2">
                        <div class="py-1 px-4 flex items-center space-x-1 text-gray-700 hover:text-blue-400 cursor-pointer" :class="route.query.type === 'all' ? 'font-semibold text-blue-600': ''">
                            ...
                            <button type="button" @click=" vaultNavigation.allVaultItems ">All items</button>
                        </div>
                    </div>
                    <hr>
                    <div class="px-4 py-2 ">
                        <div class="flex items-center text-gray-500 space-x-1">
                            ...
                            <div class="py-1 px-4 flex items-center space-x-1 text-gray-700 hover:text-blue-400" :class="route.query.type === 'all' ? 'font-semibold text-blue-600': ''">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="px-4 py-2 ">
                        ...
                        <div class="">
                            <div v-for="(folder, ind) in folders" :key="ind"  class="">
                                <button type="button" class="py-1 px-4 flex items-center justify-start text-gray-600 space-x-1 hover:text-blue-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <div class="w-full max-w-xl">
                <div class="mb-4">
                    <div class="mb-4 flex justify-between items-center">
                        ...
                        <router-link to="/vault/item/add" class="flex items-center justify-center px-3 py-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-emerald-500 rounded-md  hover:bg-emerald-600 hover:text-white">
...
const vaultNavigation = {allVaultItems};
...
function getVaultItems (type, url){
    store.dispatch('getAllVault', {type: type, url: url})
        .then(()=>{
            loading.value = false;
