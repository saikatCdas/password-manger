            ...
            <div class="w-full">
                <div class="mb-4">
                    <div class="mb-4 flex justify-between items-center">
                        ...
                        <button @click="formModalOpen =true" class="flex items-center justify-center px-3 py-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-emerald-500 rounded-md  hover:bg-emerald-600 hover:text-white">
